...
/**
 * The handler for the /auth/google/callback route.
 * This route is called after the user has authenticated with Google and Google has redirected the user back to our application.
 */
const googleCallback: Handler = async (req, res) => {
