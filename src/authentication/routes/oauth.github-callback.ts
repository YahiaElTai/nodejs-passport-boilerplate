...
/**
 * The handler for the /auth/github/callback route.
 * This route is called after the user has authenticated with GitHub and GitHub has redirected the user back to our application.
 */
const githubCallback: Handler = async (req, res) => {
